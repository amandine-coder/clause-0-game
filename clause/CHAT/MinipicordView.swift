                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ForEach(messages) { message in
                            HStack(alignment: .bottom, spacing: 6) {
                                ...
                                if !message.isAlex && message.text.contains("[link]") {
                                    VStack(alignment: .leading, spacing: 4) {
                                        let parts = message.text.components(separatedBy: "[link]")
    ...
    ZStack {
        ...
        MiniPicordView(
            ...
            exchanges: [
                Exchange(
                    alexIntro: nil,
                    haruMessage: "hey. found something. don't ask questions just try it. [link]",
                    choices: ["...ok ?"]
                ),
                Exchange(
                    alexIntro: nil,
